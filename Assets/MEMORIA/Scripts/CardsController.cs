...
public class CardsController : MonoBehaviour
{
    ...
    public void Play()
    {
        ...
        foreach (Opciones item in niveles.opciones)
        {
            ...
            {
                //Debug.LogWarning("No se encontr� la imagen: " + "images/" + procesar + "_a.png");
                Debug.LogWarning("No se encontr� la imagen: " + "images/empty_memoria.png");
                continue;
            }
            ...
            // Crea el SpritePair (puedes usar el mismo sprite para front y back, o modificar seg�n tu l�gica)
